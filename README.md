...
These services are delivered using a simple User Interface hosted online [here](https://moneygram-lend.anvil.app) and the backend can be run [here](https://colab.research.google.com/drive/1UitgPjV5kHcYWemAIibTCmFep5EhTtFP?usp=sharing).
