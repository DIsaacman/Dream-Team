...
def convert_dollars(intent_request):
    ...
    currency_buy = get_slots(intent_request)["currency"]
    ...
    api_url = "https://cdn.jsdelivr.net/gh/fawazahmed0/currency-api@1/latest/currencies/aud.json"
    response = requests.get(api_url)
    response_json = response.json()
    exchange_rate = parse_float(response_json['aud'][currency_buy])
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you. As of {}, the exchange rate for aud / {} is {}
            you can get {} $ {}  for your $ {} dollars.
            . Please Type "Borrow" to continue...
            """.format(today,currency_buy, exchange_rate,currency_buy,
                value, dollars
            ),
        },
    )
